...
unsigned int HashTable_prime_list[] = {
  433, 1543, 6091, 24281, 100169, 487651, 1179589, 2471093, 7368787, 
  32452843, 141650939, 0
};

// Following is the Hash function found from:
// http://burtleburtle.net/bob/hash/doobs.html
// Also described in Dr. Dobb's Journal, September 1997
